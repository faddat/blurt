...
func NewMsgCreatePost(creator string, title string, body string, ipfs string, parent string, category string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id string, title string, body string, ipfs string, parent string, category string) *MsgUpdatePost {
