...
import (
	...
	appparams "github.com/faddat/blurt/app/params"
	"github.com/faddat/blurt/x/blurt"
	blurtkeeper "github.com/faddat/blurt/x/blurt/keeper"
	blurttypes "github.com/faddat/blurt/x/blurt/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/.blurt")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	blurtKeeper blurtkeeper.Keeper
...
func New(
	...
	app.blurtKeeper = *blurtkeeper.NewKeeper(
        appCodec, keys[blurttypes.StoreKey], keys[blurttypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		blurt.NewAppModule(appCodec, app.blurtKeeper),
